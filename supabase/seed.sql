...
values (
  '가천대학교',
  'gachon-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/gachon/logo.jpg',
...
values (
  '세종대학교',
  'sejong-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/sejong/sejong-campus.png',
...
values (
  '중앙대학교',
  'chungang-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/chungang/chungang-logo.png',
  'https://www.cau.ac.kr',
  '서울특별시',
  '서울특별시 동작구 흑석로 84',
...
values (
  '한양대학교',
  'hanyang-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/hanyang/hanyang-logo.png',
...
values (
  '서강대학교',
  'sogang-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/sogang/sogang-logo.png',
...
values (
  ...
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/sungkyunkwan/sungkyunkwan-logo.jpg',
  'https://www.skku.edu',
  '서울특별시',
  '서울특별시 종로구 성균관로 25-2',
...
values (
  '경희대학교',
  'kyunghee-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/kyunghee/kyunghee-logo.png',
  'https://www.khu.ac.kr',
  '서울특별시',
  '서울특별시 동대문구 경희대로 26',
...
values (
  '연세대학교',
  'yonsei-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/yonsei/logo.jpg',
...
values (
  ...
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/hufs/logo.jpg',
...
values (
  '서울시립대학교',
  'university-of-seoul',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/uos/logo.jpg',
  'https://www.uos.ac.kr',
  '서울특별시',
...
values (
  '동국대학교',
  'dongguk-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/dongguk/logo.jpg',
...
values (
  '숭실대학교',
  'soongsil-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/soongsil/logo.jpg',
  'https://www.ssu.ac.kr',
  '서울특별시',
  '서울특별시 동작구 상도로 369',
...
values (
  '건국대학교',
  'konkuk-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/konkuk/konkuk-campus.jpeg',
...
values (
  '홍익대학교',
  'hongik-university',
  'https://skzdwrzrmbiqlrevwdgb.supabase.co/storage/v1/object/public/uyou/universities/hongik/logo.jpg',
...
cross join (
  values
    ...
    (
      '정치외교학전공',
      'Major of Political Science and Diplomacy',
      2026
    ),
    ...
    (
      '경찰행정학부',
      'Division of Police Administration',
      2026
    ),
    ...
    (
      '컴퓨터·AI학부',
      'Division of Computer Science and Artificial Intelligence',
      2026
    ),
    ...
    (
      '의료인공지능공학과',
      'Department of Medical AI Engineering',
      2026
    ),
    ...
    (
      '융합환경과학과',
      'Department of Converging Environmental Sciences',
      2026
    ),
    ...
    (
      '식품바이오융합공학과',
      'Department of Food-Bioscience Integrative Technology',
      2026
    ),
...
where u.slug = 'dongguk-university'
...
cross join (
  values
    ...
    (
      '예술창작학부 - 영화예술전공',
      'School of Creative Writing and Arts - Film Arts Major',
      2026
    ),

    (
      '스포츠학부 - 생활체육전공',
      'School of Sports - Sport for All Studies Major',
      2026
    ),

    (
      '스포츠학부 - 스포츠사이언스전공',
      'School of Sports - Sport Science Major',
      2026
    ),
    ...
    (
      '사회복지학부 - 사회복지실천전공',
      'School of Social Welfare - Social Welfare Practice Major',
      2026
    ),

    (
      '사회복지학부 - 사회복지정책·행정전공',
      'School of Social Welfare - Social Welfare Policy and Administration Major',
      2026
    ),

    (
      '행정학부 - 공공관리·정책기획전공',
      'School of Public Administration - Public Management and Policy Planning Major',
      2026
    ),

    (
      '행정학부 - 정책평가·데이터분석전공',
      'School of Public Administration - Policy Evaluation and Data Analysis Major',
      2026
    ),
    ...
    (
      '경영학부 - HR & Marketing전공',
      'School of Business Administration - HR and Marketing Major',
      2026
    ),

    (
      '경영학부 - OM & MIS전공',
      'School of Business Administration - Operations Management and MIS Major',
      2026
    ),

    (
      '경영학부 - Financial Management전공',
      'School of Business Administration - Financial Management Major',
      2026
    ),
    ...
    (
      '금융학부 - 디지털금융전공',
      'School of Finance - Digital Finance Major',
      2026
    ),

    (
      '금융학부 - 글로벌금융전공',
      'School of Finance - Global Finance Major',
      2026
    ),
    ...
    (
      '의생명시스템학부 - 생명정보학전공',
      'School of Medical Biosystems - Bioinformatics Major',
      2026
    ),

    (
      '의생명시스템학부 - 생명공학전공',
      'School of Medical Biosystems - Biotechnology Major',
      2026
    ),
    ...
    (
      '전기공학부 - 전기에너지전공',
      'School of Electrical Engineering - Electrical Energy Major',
      2026
    ),

    (
      '전기공학부 - 전기정보전공',
      'School of Electrical Engineering - Electrical Information Major',
      2026
    ),
    ...
    (
      '컴퓨터학부 - 시스템소프트웨어전공',
      'School of Computer Science - System Software Major',
      2026
    ),

    (
      '컴퓨터학부 - 융합소프트웨어전공',
      'School of Computer Science - Convergence Software Major',
      2026
    ),

    (
      '전자정보공학부 - 전자공학전공',
      'School of Electronic Information Engineering - Electronic Engineering Major',
      2026
    ),

    (
      '전자정보공학부 - IT융합전공',
      'School of Electronic Information Engineering - IT Convergence Major',
      2026
    ),

    (
      '글로벌미디어학부 - AI미디어공학전공',
      'Global School of Media - AI Media Engineering Major',
      2026
    ),

    (
      '글로벌미디어학부 - 크리에이터콘텐츠전공',
      'Global School of Media - Creative Content Major',
      2026
    ),
    ...
    (
      'AI소프트웨어학부 - 소프트웨어전공',
      'School of AI Software - Software Major',
      2026
    ),

    (
      'AI소프트웨어학부 - 정보보호전공',
      'School of AI Software - Information Security Major',
      2026
    ),

    (
      'AI소프트웨어학부 - 인공지능전공',
      'School of AI Software - Artificial Intelligence Major',
      2026
    ),

    (
      'AI소프트웨어학부 - AI시스템전공',
      'School of AI Software - AI Systems Major',
      2026
    )
...
where u.slug = 'soongsil-university'
